...
public class SimpleMail {
    ...
    private static final String SMTP_AUTH_USER = "jeffe1258@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "jEFFERSONJFRY1992"; //password/secret
